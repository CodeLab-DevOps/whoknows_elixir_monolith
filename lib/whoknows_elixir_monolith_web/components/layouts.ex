defmodule WhoknowsElixirMonolithWeb.Layouts do
  @moduledoc """
  ...
  def theme_toggle(assigns) do
    ...
    >
      <div
        id="theme-indicator"
        class="absolute w-1/3 h-full rounded-full border-1 border-base-200 bg-base-100 brightness-200 left-0 transition-[left]"
      />
      <button
